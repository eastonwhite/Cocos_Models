...
<<results=tex,echo=FALSE>>=
	...
	for (j in 10:15){
		file=paste("histogram_counts", names(cocos[j]), ".pdf", sep="")
...
<<results=tex,echo=FALSE>>=
	for (j in 10:15){
		file=paste("boxplot_count_vs_diver",names(cocos[j]), ".pdf", sep="")
		pdf(file=file, paper="special",width=8,height=5)
...
<<results=tex,echo=FALSE>>=
	for (j in 10:15){
		file=paste("boxplot_count_vs_site", names(cocos[j]), ".pdf", sep="")
		pdf(file=file, paper="special",width=8,height=5)
