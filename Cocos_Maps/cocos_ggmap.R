...
pngMAP_df[pngMAP_df=='#ADADAD']='grey'
pngMAP_df[pngMAP_df=='grey']='#FFFFFF'
pngMAP_df[pngMAP_df=='white']='#AEAEAE'

pngMAP_df[pngMAP_df!='#AEAEAE']='white'
...
########################
#commands to add error bar (from http://editerna.free.fr/wp/?p=76 by Ewen on 10 november 2013)
library(maps)
library(maptools)
library(ggplot2)
library(grid)
